...
class MissingNonTerminalTypes(EqualitySupportingException):
...
class UnexpectedNonTerminalTypes(EqualitySupportingException):
...
class MissingRootNonTerminalType(EqualitySupportingException):
